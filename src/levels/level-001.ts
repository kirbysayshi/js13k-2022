...
export function Level001(ces: CES3C) {
  ...
  makeEnemy(ces, vv2(60, 98), 2);
  makeEnemy(ces, vv2(64, 98), 1, 0.2);
  makeEnemy(ces, vv2(68, 98), 1, 0.2);
  makeEnemy(ces, vv2(72, 98), 1, 0.2);
  makeEnemy(ces, vv2(76, 98), 1, 0.2);
  makeEnemy(ces, vv2(82, 98), 1, 0.2);
}
